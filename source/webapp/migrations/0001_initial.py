# Generated by Django 2.2 on 2019-11-16 05:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('other', 'Другое'), ('food', 'Еда'), ('clothes', 'Одежда'), ('it', 'ИТ'), ('fashion', 'Мода')], default='other', max_length=50, verbose_name='Категория')),
